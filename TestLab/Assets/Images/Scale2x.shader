     ...
     SubShader
     {
         ...
         Pass
         {
             ...
             float4 frag(Fragment IN) : COLOR
             {
                 ...
                 float offset = 0.3;
                 float4 c0 = tex2D (_MainTex, float2((xInt+xDirc+offset)/_width, (yInt+yDirc+offset)/_height));
                 float4 c1 = tex2D (_MainTex, float2((xInt+offset)/_width, (yInt+yDirc+offset)/_height));
                 ...
                 float4 c4 = tex2D (_MainTex, float2((xInt-xDirc+offset)/_width, (yInt+offset)/_height));
